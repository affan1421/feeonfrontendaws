...
const api = create<ApiState>((set) => {
  ...
  return {
    ...
    getClassesbyCategory: async (school_id: string, category_id: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feestructure/unmapped?schoolId=${school_id}&categoryId=${category_id}`
      );
    },

    getClassesbyDiscount: async (school_id: string, discount_id: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feestructure/unmapped?schoolId=${school_id}&discountId=${discount_id}`
      );
    },

    getClasses: async (school_id: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feestructure/unmapped?schoolId=${school_id}`
      );
    },
    ...
    getYearAcademicInfo: async (
      ...
      if (!isActive) {
        return feeOn.get(
          `${baseUrlFeeOn}/config?schoolId=${school_id}${
            page ? `&page=${page}` : ""
          }${limit ? `&limit=${limit}` : ""}`
        );
      } else {
        return feeOn.get(
          `${baseUrlFeeOn}/config?schoolId=${school_id}&isActive=true`
        );
      }
    },
    ...
    updateAckReceipt: async (id: string, ackReceipt: string) => {
      return growOn.get(
        `${baseUrlGrowon}/school/${id}/updateLead?ackReceipt=${ackReceipt}`
      );
    },
    ...
    getFeeCategories: async (
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/feecategory?schoolId=${school_id}${
    ...
    fetchFeeStructurebySectionandFeeCategory: async (
      section_id: string,
      category_id: string
    ) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feestructure/category/${category_id}/section/${section_id}`
      );
    },

    fetchFeeStructuresbySectionandCategory: async (
      sectionId: string,
      categoryId: string,
      discountId: string
    ) => {
    ...
    getStudentsandFeeDetails: async (
      feeStructureId: string,
      sectionId: string
    ) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feestructure/${feeStructureId}/feedetails/${sectionId}`
      );
    },
    ...
    getDiscountTypes: async (
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/discount?schoolId=${school_id}&page=${page}&limit=${limit}`
      );
    },
    ...
    assignDiscount: async (discount_id: string, discount: APIData) => {
      return feeOn.post(
        `${baseUrlFeeOn}/discount/${discount_id}/map`,
        discount
      );
    },
    ...
    updateStudentsinAssignDiscount: async (discount_id: string, data: any) => {
      return feeOn.post(
        `${baseUrlFeeOn}/discount/${discount_id}/addStudent`,
        data
      );
    },

    fetchStudentsbyDiscountandStructure: async (
      discount_id: string,
      feestructure_id: string,
      sectionId: string
    ) => {
      return feeOn.get(
        `${baseUrlFeeOn}/discount/${discount_id}/structure/${feestructure_id}?sectionId=${sectionId}`
      );
    },

    fetchStudentsforDiscountApproval: async (
      discount_id: string,
      sectionId?: string,
      status?: string
    ) => {
    ...
    updateStudentStatusinDiscountAPI: async (
      discount_id: string,
      student: DiscountStudentAPI
    ) => {
      return feeOn.post(
        `${baseUrlFeeOn}/discount/${discount_id}/approval`,
        student
      );
    },
    ...
    getFeeDetailsbyClassRow: async (
      discount_id: string,
      section_id: string
    ) => {
      return feeOn.get(
        `${baseUrlFeeOn}/discount/${discount_id}/section/${section_id}`
      );
    },
    ...
    getStudentsbySectionandCategory: async (
      sectionId: string,
      categoryId: string
    ) => {
      return growOn.get(
        `${baseUrlGrowon}/student/section/${sectionId}/category/${categoryId}`
      );
    },
    ...
    getRecentTransaction: async (schoolId: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feeinstallment/allTransactions?schoolId=${schoolId}&page=0&limit=50`
      );
    },
    ...
    getMiscellaneousFeeTypes: async (
      schoolId: string,
      page?: number,
      limit?: number
    ) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feetype?schoolId=${schoolId}&isMisc=true${
          page !== undefined ? `&page=${page}` : ""
        }${limit ? `&limit=${limit}` : ""}`
      );
    },
    ...
    getIncomeDashboardData: async (
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/feeinstallment/incomeDashboard?schoolId=${schoolId}${
          date ? `&dateRange=${date}` : ""
    ...
    getExpenseTypes: async (school_id: string, page: number, limit: number) => {
      return feeOn.get(
        `${baseUrlFeeOn}/expenseType?schoolId=${school_id}&page=${page}&limit=${limit}`
      );
    },

    getExpenseTypeNames: async (school_id: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/expenseType/byschool?schoolId=${school_id}`
      );
    },
    ...
    getExpenseDashboardData(
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/expense/dashboard?schoolId=${schoolId}${
    ...
    getIncomeExcel(
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/feereceipt/excel?schoolId=${schoolId}${
    ...
    getExpenseExcel(
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/expense/excel?schoolId=${schoolId}${
    ...
    getDonorList(schoolId: string, page: number, limit: number) {
      return feeOn.get(
        `${baseUrlFeeOn}/donor?schoolId=${schoolId}&page=${page}&limit=${limit}`
      );
    },
    ...
    getStudentsListDonor(donorId: string, page: number, limit: number) {
      return feeOn.get(
        `${baseUrlFeeOn}/donor/${donorId}/donations?page=${page}&limit=${limit}`
      );
    },
    ...
    dashboardStats: async (
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/feereceipt/dashboard?schoolId=${schoolId}${
          dateRange ? `&dateRange=${dateRange}` : ""
        }${startDate ? `&startDate=${startDate}` : ""}${
          endDate ? `&endDate=${endDate}` : ""
        }`
    ...
    getStudentsBySectionandAcademicYear: async (
      sectionId: string,
      academicYearId: string
    ) => {
      return feeOn.get(
        `${baseUrlFeeOn}/previousfees/students?sectionId=${sectionId}&academicYearId=${academicYearId}`
      );
    },

    downloadExcelExistingStudents: async (
      schoolId: string,
      studentList: string[],
    ...
    importExcel: (schoolId: string, data: FormData, isExisting: boolean) => {
      return feeOn.post(
        `${baseUrlFeeOn}/previousfees/bulkCreate?schoolId=${schoolId}&isExisting=${isExisting}`,
        data
      );
    },
    ...
    getFeeSchedule: (schoolId: string, categoryId?: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feeschedule?schoolId=${schoolId}${
    ...
    getCardsData: (
      ...
      return feeOn.post(
        `${baseUrlFeeOn}/feeinstallment/reportBySchedules`,
        data
      );
    },
    ...
    getStudentReport: (studentId: string, categoryId: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/feeinstallment/studentReport?studentId=${studentId}&categoryId=${categoryId}`
      );
    },
    ...
    getSectionWiseData: (page: number, limit: number) => {
      return feeOn.get(
        `${baseUrlFeeOn}/discount/sections?page=${page}&limit=${limit}`
      );
    },

    getFeeDetails(feeStructureId: string, discountId: string) {
      return feeOn.get(
        `${baseUrlFeeOn}/feestructure/${feeStructureId}/discount/${discountId}`
      );
    },
    ...
    getClassSummaryById: (sectionId: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/discount/summary?sectionId=${sectionId}`
      );
    },
    ...
    getStudentsGiveDiscount: (
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/discount/${discountId}/structure/${feeStructureId}?sectionId=${sectionId}`
      );
    },
    ...
    getDiscountApproval: (
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/discount/approval?page=${page}&limit=${limit}${
          sectionId ? `&sectionId=${sectionId}` : ""
    ...
    getStudentList: (
      ...
      return feeOn.get(
        `${baseUrlFeeOn}/discount/studentList?page=${page}&limit=${limit}${
          sectionId ? `&sectionId=${sectionId}` : ""
        }${searchTerm ? `&searchTerm=${searchTerm}` : ""}`
      );
    },
    ...
    approvalPaymentConfirmation: (data: ApprovalAPIData, receiptId: string) => {
      return feeOn.post(
        `${baseUrlFeeOn}/feereceipt/${receiptId}/confirmations`,
        data
      );
    },
    ...
    changeTcStatus: (id: string, status: string) => {
      return feeOn.put(
        `${baseUrlFeeOn}/transfercertificate/changeStatus/${id}?status=${status}`
      );
    },
    viewTcDetails: (id: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/transfercertificate/tcStudentsDetails?studentTcId=${id}`
      );
    },
    ...
    todaysTotalFees: (schoolId: string, date: any) => {
      return feeOn.get(
        `${baseUrlFeeOn}/dailyclosecollection/todaystotalfees?schoolId=${schoolId}&date=${date}`
      );
    },
    getDailyCloseCollection: (
      schoolId: string,
      searchQuery: string,
      date: string,
      page: number,
    ...
    updateEditStatus: (schoolId: string, status: boolean) => {
      return feeOn.put(
        `${baseUrlFeeOn}/dailyclosecollection/allowEdit?schoolId=${schoolId}&status=${status}`
      );
    },
    getEditStatus: (schoolId:string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/dailyclosecollection/allowEdit?schoolId=${schoolId}`
      );
    },
    getTcReasonsForGenerateTc: (schoolId: string) => {
      return feeOn.get(
        `${baseUrlFeeOn}/transfercertificate/reasons?schoolId=${schoolId}`
      );
    },
    ...
    getRouteDetails: async (schoolId: string, searchQuery?: string) => {
      return feeOn.get(`${baseUrlFeeOn}/transportation/searchRoute?schoolId=${schoolId}${searchQuery ? `&searchQuery=${searchQuery}` : ""}`)
    },
    ...
    getDriverList: async (schoolId: string, searchQuery?: string, page?:number, limit?:number) => {
      return feeOn.get(`${baseUrlFeeOn}/transportation/list-drivers?schoolId=${schoolId}${searchQuery ? `&searchQuery=${searchQuery}` : ""}&page=${page}&limit=${limit}`)
    },
    ...
    getVehicleList: async (schoolId: string, searchQuery?: string, page?:number, limit?:number) => {
      return feeOn.get(`${baseUrlFeeOn}/transportation/list-vehicles?schoolId=${schoolId}${searchQuery ? `&searchQuery=${searchQuery}` : ""}&page=${page}&limit=${limit}`)
    },
    ...
    getStudentsList: async (schoolId: string,classId?:string, searchQuery?: string, page?: number, limit?: number) => {
      return feeOn.get(`${baseUrlFeeOn}/transportation/student-transport-list?schoolId=${schoolId}${classId ? `&classId=${classId}` : ''}${searchQuery ? `&searchQuery=${searchQuery}` : ""}&page=${page}&limit=${limit}`)
    },
    ...
    getTransportData: async (schoolId: string, month?: string) => {
      return feeOn.get(`${baseUrlFeeOn}/transportation/dashboard-data?schoolId=${schoolId}${month ? `&month=${month}` : ""}`)
    }
