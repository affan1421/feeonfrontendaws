  ...
  return (
    <div className={styles.detail_card}>
      ...
      <Input
        ...
        onChange={(event) =>
          setInputValues({ ...inputValues, idField: event.target.value })
        }
      />
        ...
        <>
          ...
          <div>
            <DatePicker
              ...
              onChange={(date) =>
                setInputValues({ ...inputValues, dateField: date })
              }
            />
...
const MakePayment = (props: MakePaymentProps) => {
  ...
  const getTransactionsbyStudentAPI = api(
    (state) => state.getTransactionsbyStudent
  );
  ...
  const [corresspondenceReceipt, setCorresspondenceReceipt] =
    useState("default");
  ...
  const handlePay = async () => {
    ...
    let data: FeeCollectionAPI = {
      ...
      status:
        paymentMode !== "Cash" &&
        schoolDetails.permissions.ackReceipt === "MANAGEMENT"
          ? "PENDING"
          : "APPROVED",
    ...
    try {
      ...
      if (errorMessage) {
        ...
        paymentMode !== "Cash" &&
        schoolDetails.permissions.ackReceipt === "BOTH"
      ) {
    ...
    <div className={styles.main}>
      ...
      <Dialog open={dialogEnabled} maxWidth="xl">
        <Receipt
          ...
          setIsMakePayment={props.setIsMakePayment}
        />
      </Dialog>
      <Dialog open={dialogDonorEnabled} maxWidth="xl">
        <AddDonor
          onFormSubmit={handleAddDonor}
          setDialogEnabled={setDialogDonorEnabled}
        />
      </Dialog>
